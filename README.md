...
| scope  | -  | array  | Array of scopes to be forwarded in request. Current support for [google](https://developers.google.com/identity/protocols/googlescopes) only; others to come  |
